...
//         // Create new salary record (ID will be auto-incremented in pre-save hook)
...
// //Bulk  assign salary for all the supervisorsProcessing:
...
//         const supervisors = await Supervisor.find({ status: 'Active' });
...
// 2. Get All Salary Records (with supervisor validation)
