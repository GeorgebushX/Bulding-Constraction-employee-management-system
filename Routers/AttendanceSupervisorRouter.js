...
// router.get('/supervisors/attendance/yes',authMiddleware, getSupervisorAttendance);
...
// // // import express from 'express';
// // // import {
// // // createSupervisorAttendanceByName,
...
// // // const router = express.Router();
// // // router.post('/supervisors/attendance',authMiddleware, createSupervisorAttendanceByName);
// // // router.get('/supervisors/attendance/yes',defaultAttendance, authMiddleware, getTodaySupervisorAttendance);

// // // // // Basic attendance routes
// // // // // router.get('/attendance',defaultAttendance, authMiddleware, getAllAttendance);
// // // // router.get('/supervisors/attendance/daily',defaultAttendance, authMiddleware, getDailyAttendance);
...
// // // // router.put('/supervisors/attendance/:id', authMiddleware, updateAttendanceById);
// // // // router.put('/supervisors/attendance/status/:supervisorId', authMiddleware, updateStatusBySupervisorAndDate);
  
// // // // // getTodaySupervisorAttendance     
// // // // router.get('/supervisors/attendance/today', authMiddleware, getTodaySupervisorAttendance);
// // // // // filter by date:
