...
const contractorSchema = new mongoose.Schema({
  ...
  roleDetails: {
    type: mongoose.Schema.Types.Mixed, // Flexible structure for role details
    default: null
  },
  bankAccount: { type: String, trim: true },
  bankCode: { type: String, trim: true },
...
contractorSchema.statics.workerTypesConfig = {
  'Centering Contractor': ['Fitter', 'Helper', 'Temporary Centering Worker'],
  'Steel Contractor': ['Fitter', 'Helper', 'Temporary Steel Worker'],
  'Mason Contractor': ['Mason', 'Chital', 'Material Handler', 'Temporary Worker'],
  'Carpenter Contractor': ['Fitter', 'Helper', 'Temporary Carpenter'],
  'Plumber Contractor': ['Plumber', 'Helper', 'Temporary Plumber'],
  'Electrician Contractor': ['Electrician', 'Helper', 'Temporary Electrician'],
  'Painter Contractor': ['Painter', 'Helper', 'Temporary Painter'],
  'Tiles Contractor': ['Fitter', 'Helper', 'Temporary Tiles Worker']
};

// Method to get worker types for a contractor
contractorSchema.methods.getWorkerTypes = function() {
  return contractorSchema.statics.workerTypesConfig[this.contractorRole] || [];
};
